...
const Boys = () => {
  const boysProducts = [
    ...
    { id: 3, title: 'Радиоуправляемая машина', price: 3990, image: 'https://cdn.poehali.dev/projects/167001b8-6670-417d-8bd7-654ad66d60a3/files/02dcd939-3023-4209-a9ff-956cdccd0b90.jpg' },
