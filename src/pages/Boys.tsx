...
const Boys = () => {
  const boysProducts = [
    ...
    { id: 3, title: 'Радиоуправляемый джип', price: 3990, image: 'https://cdn.poehali.dev/projects/167001b8-6670-417d-8bd7-654ad66d60a3/files/04ad4ea8-f39f-4e5f-b2b6-f5bab5082555.jpg' },
